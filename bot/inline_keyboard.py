...
button_date_9 = InlineKeyboardButton('Другая', callback_data='any')

DATE = InlineKeyboardMarkup().row(button_date_1, button_date_2).add(button_date_3, button_date_4, button_date_5, button_date_6, button_date_7, button_date_8,button_date_9)
...
button_seat_1 = InlineKeyboardButton("Низ", callback_data="низ")
button_seat_2 = InlineKeyboardButton("Верх", callback_data="верх")
button_seat_3 = InlineKeyboardButton("Любая", callback_data="любая")


SEAT = InlineKeyboardMarkup().row(button_seat_1, button_seat_2).add(button_seat_3)
